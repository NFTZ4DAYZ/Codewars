...
// ou probably know that number 42 is "the answer to life, the universe and everything" according to Douglas Adams' "The Hitchhiker's Guide to the Galaxy". For Freud, the answer was quite different...
...
function toFreud(string) {
    if(string.length == 0) {
      return ''
    }else return 'sex '.repeat(string.split(' ').length).trim()
    }